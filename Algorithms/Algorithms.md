...
* [Bubble Sort](Sorting/BubbleSort/BubbleSort.md)
* [Insertion Sort](Sorting/InsertionSort/InsertionSort.md)
* [Selection Sort](Sorting/SelectionSort/SelectionSort.md)
* [Merge Sort](Sorting/MergeSort/MergeSort.md)
* [Quick Sort](Sorting/QuickSort/QuickSort.md)
* [Heap Sort](Sorting/HeapSort/HeapSort.md)
* [Swap Sort](Sorting/SwapSort/SwapSort.md)
* [Radix Sort](Sorting/RadixSort/RadixSort.md)
* [Shell Sort](Sorting/ShellSort/ShellSort.md)
* [Count Sort](Sorting/CountSort/CountSort.md)


## [Graph Search](Graph Search/Graph_Search.md)
...
* [Breadth First Search](Graph Search/BreadthFirstSearch/BreadthFirstSearch.md)
* [Depth First Search](Graph Search/DepthFirstSearch/DepthFirstSearch.md)
* [Dijkstra's Algorithm](Graph Search/Dijkstra'sAlgorithm/Dijkstra%27sAlgorithm.md)
* [A* Search](Graph Search/A*Search/A%2ASearch.md)

## [Dynamic Programming](Dynamic Programming/Dynamic_Programming.md)
...
* [Fibonacci Sequence](Dynamic Programming/Fibonacci Sequence/Fibonacci_Sequence.md)
...
* [Coin Change](DynamicProgramming/CoinChange/CoinChange.md)
...
* [Prim's Algorithm](Greedy Algorithm/Prim's Algorithm/Prim%27s_Algorithm.md)
* [Kruskal's Algorithm](Greedy Algorithm/Krushkal's Algorithm/Krushkal%27s_Algorithm.md)
...
* [N-Queens](Backtracking/N-Queens/N-Queens.md)
* [Sudoku](Backtracking/Sudoku/Sudoku.md)
* [M Coloring](Backtracking/MColoring/MColoring.md)
* [Hamiltonian Cycle](Backtracking/HamiltonianCycle/HamiltonianCycle.md)
* [Word Break](Backtracking/WordBreak/WordBreak.md)
* [Rat in a Maze](Backtracking/RatinMaze/RatinMaze.md)
* [N Queen Problem](Backtracking/NQueenProblem/NQueenProblem.md)
* [Sum of Subset](Backtracking/SumofSubset/SumofSubset.md)
* [Solve Sudoku](Backtracking/SolveSudoku/SolveSudoku.md)
* [Knight's Tour](Backtracking/KnightsTour/KnightsTour.md)
...
* [0-1 Knapsack](BranchandBound/0-1Knapsack/0-1Knapsack.md)
* [Travelling Salesman Problem](BranchandBound/TravellingSalesmanProblem/TravellingSalesmanProblem.md)
...
* [Linear Search](Searching/LinearSearch/LinearSearch.md)
* [Binary Search](Searching/BinarySearch/BinarySearch.md)
